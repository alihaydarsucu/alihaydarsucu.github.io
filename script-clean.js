document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupCleanURLs() {
        // Sayfa yüklendiğinde URL'i temizle
        const path = window.location.pathname;
        
        // .html dosyalarında URL'i temiz versiyona çevir
        const cleanUrls = {
            '/index.html': '/',
            '/skills.html': '/skills',
            ...
            '/yetenekler.html': '/yetenekler',
            '/projeler.html': '/projeler',
            '/deneyim.html': '/deneyim'
        };
        
        if (cleanUrls[path]) {
            window.history.replaceState(null, '', cleanUrls[path]);
        }
        
        // Link tıklamalarını yakalamak için event listener
        document.addEventListener('click', function(e) {
            ...
            // Clean URL'leri .html dosyalarına yönlendir
            const routes = {
                '/': 'index.html',
                '/skills': 'skills.html',
                ...
                '/yetenekler': 'yetenekler.html',
                '/projeler': 'projeler.html',
                '/deneyim': 'deneyim.html'
            };
